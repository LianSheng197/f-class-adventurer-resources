...
[AddComponentMenu("Table/DesignCharacteristicLevel")]
public class DesignCharacteristicLevel : TableBase
{
	[Serializable]
	public class Data
	{
		...
		public int needCharacteristicType;

		public int needCharacteristicLevel;
