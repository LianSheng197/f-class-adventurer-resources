...
[AddComponentMenu("Table/DesignLanguage")]
public class DesignLanguage : TableBase
{
	[Serializable]
	public class Data
	{
		...
		public string GetLanguageValue(SupportLanguage.Language language)
		{
			return null;
		}

		public string GetLanguageValue(int language)
		{
			return null;
		}
