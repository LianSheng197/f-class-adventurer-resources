...
namespace Unity.Services.Analytics.Data
{
	internal interface IDataGenerator
	{
		...
		void AdImpression(ref IBuffer buf, DateTime datetime, StdCommonParams commonParams, string callingMethodIdentifier, AdImpressionParameters adImpressionParameters);
		...
		void AcquisitionSource(ref IBuffer buf, DateTime datetime, StdCommonParams commonParams, string callingMethodIdentifier, AcquisitionSourceParameters acquisitionSourceParameters);
	}
}
