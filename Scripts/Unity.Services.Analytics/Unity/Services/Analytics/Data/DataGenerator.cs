...
namespace Unity.Services.Analytics.Data
{
	internal class DataGenerator : IDataGenerator
	{
		...
		public void AdImpression(ref IBuffer buf, DateTime datetime, StdCommonParams commonParams, string callingMethodIdentifier, AdImpressionParameters adImpressionParameters)
		{
		}

		public void AcquisitionSource(ref IBuffer buf, DateTime datetime, StdCommonParams commonParams, string callingMethodIdentifier, AcquisitionSourceParameters acquisitionSourceParameters)
		{
		}
