...
{
	internal class Future_User : FutureBase
	{
		...
		internal Future_User(IntPtr cPtr, bool cMemoryOwn)
		{
		}

		internal static HandleRef getCPtr(Future_User obj)
		{
		...
		public static Task<FirebaseUser> GetTask(Future_User fu)
		{
			return null;
		}
